...
//map()
//map() 함수는 리스트의 각 요소를 순회하면서, 주어진 함수를 적용한 새로운 값을 반환하여 새로운 리스트나 다른 Iterable을 생성하는 함수이다.
//map() 함수는 기존 리스트의 요소들을 직접 복사하지 않는다. 대신, 각 요소에 대해 주어진 함수가 적용된 결과를 모아 새로운 리스트를 반환합니다.
//이는 얕은 복사가 아니라, 리스트의 각 요소에 대한 변환이다.
